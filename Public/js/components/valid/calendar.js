...
#cal_ft {padding:5px 0;}';
			...
			var html = [];
			var sSelect = ['<select></select> ', '<img src="' + QW.PATH + 'components/valid/assets/UpAndDown.gif" align="absMiddle" usemap="#year_change_map"/>', '<map name="year_change_map">', '<area shape="rect" coords="0,0,13,8" href="#"/>', '<area shape="rect" coords="0,10,13,17" href="#"/>', '</map>'].join("");
