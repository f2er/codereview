/*import from ./components/anim/anim.frame.js,(by build.py)*/
...
mix(window, ah);
})();/*import from ./components/anim/anim.base.js,(by build.py)*/
...
(function() {
	...
	function _play(anim, begin, end){
		if(!anim._requestID){
			...
			anim._timeStamp = new Date() - begin * anim.dur;
...
})();/*import from ./components/anim/anim.el.js,(by build.py)*/
...
(function() {	
	...
	mix(AnimAgent.prototype, { 
		...
		getValue : function(){
			var val = getStyle(this.el, this.attr);
...
})();/*import from ./components/anim/anim.easing.js,(by build.py)*/
...
*/
 ...
 })();/*import from ./components/anim/anim_retouch.js,(by build.py)*/
